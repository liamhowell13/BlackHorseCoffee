    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Caramel Brulee Latte", description: "Espresso, caramel, torched sugar top", price: "6.25" },
  ...
  },
  {
    ...
    categories: [
      ...
      },
      {
        category: "Savory",
        items: [
          { name: "Ham & Cheese Croissant", description: "Black forest ham, gruyere, dijon", price: "6.50" },
